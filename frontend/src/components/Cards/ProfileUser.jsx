    ...
    <>
      ...
      >
        ...
        >
          ...
          <Rating value={'5'} text={`20 services)`} />
        ...
        <Card.Body>
          ...
          >
            ...
            >
              <span style={{ marginRight: '5px' }}> {'Not mentionned'}</span>
            </span>
          </Card.Text>
          <Card.Text
            className='d-flex justify-content-between align-items-center'
          ...
          >
            ...
            <span style={{ fontWeight: '400' }}>2030-34-342</span>
          </Card.Text>
        </Card.Body>
        <Card.Footer
          className='text-center'
        ...
        >
          ...
          <Button className='back-btn' style={{ margin: '5px auto' }}>
            Toggle availability
          </Button>
        </Card.Footer>
      </Card>
